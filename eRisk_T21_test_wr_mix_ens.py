...
create_bw_data_test(CLAS_PATH+'/'+'tmp'+'/'+'tests'+'/', LM_PATH+'/'+'tmp'+'/'+'itos.pkl')

prediction_fw, samplIdx_fw, pos_prob_fw = eval_clas_eRisk(str(CLAS_PATH), 2, lm_id=lm_id, clas_id=clas_id, attention=False)
prediction_bw, samplIdx_bw, pos_prob_bw = eval_clas_eRisk(str(CLAS_PATH), 2, lm_id=lm_id, clas_id=clas_id, attention=False, backwards=True)
...
np.save(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'prediction_eRisk_dep_wr_ens.npy', prediction)
np.save(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'samplIdx_eRisk_dep_wr_ens.npy', samplIdx)
np.save(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'pos_prob_eRisk_dep_wr_ens.npy', pos_prob)

prediction = np.load(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'prediction_eRisk_dep_wr_ens.npy')
samplIdx = np.load(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'samplIdx_eRisk_dep_wr_ens.npy')
pos_prob = np.load(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'pos_prob_eRisk_dep_wr_ens.npy')
...
All_df.to_csv(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'Results1_wr_ens.csv', header=False, index=False)
...
df_val_ALL_OUT.to_pickle(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'df_val_ALL_OUT_ens.pkl')
subjIDs_unq = set(subjIDs)

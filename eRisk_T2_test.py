...
prediction, samplIdx = eval_clas_eRisk(str(CLAS_PATH), 2, lm_id='eRisk_anx_FT', clas_id='eRisk_anx_1', attention=False)
...
np.save(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'prediction_eRisk_anx.npy', prediction)
np.save(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'samplIdx_eRisk_anx.npy', samplIdx)

prediction = np.load(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'prediction_eRisk_anx.npy')
samplIdx = np.load(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'samplIdx_eRisk_anx.npy')
...
All_df.to_csv(str(CLAS_PATH)+'/'+'tmp/tests'+'/'+'Results_anx_1.csv', header=False, index=False)

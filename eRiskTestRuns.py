...
from eRisk_T2_runs_test import *
...
wrDirs = 'Java/Data/test/writings'
decDirs = 'Java/Data/test/Decisions2'

seqNum = -1
args = ['erisk-test-participant-0.1-jar-with-dependencies.jar']
while(True):
    ######### Get writings ###############
    getWrArgs = args + ['1']
    ...
    if(currentSeq == seqNum):
        ...
        #eRisk_test_runs(wrDirs, decDirs)
        #break;
    else:
        print('Processing sequence number ...' + str(currentSeq))
        seqNum = currentSeq

    if ((currentSeq >= 0) & ((currentSeq % 300) == 0)):
